...
const Info = () => {
    return (
        <div className='info-wrapper'>
            ...
            <Container className="infobar d-grid">
                <Row>
                    <Col className="col-2 d-none d-lg-flex">
                        Livrare rapidă
                    ...
                    <Col className='col-2 d-none d-lg-flex'>
                        ...
                        <svg width="24" height="24" viewBox="0 0 22 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11 26C11 26 21 21 21 13.5V4.75L11 1L1 4.75V13.5C1 21 11 26 11 26Z" stroke="#2c2f2580" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
