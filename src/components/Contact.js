    ...
    <>
      ...
      >
        <div className="contact" id="contact-form">
          ...
          <p>
            {language === "RO"
              ? "Scrie-ne un mesaj iar noi îți vom răspunde cât mai curând"
