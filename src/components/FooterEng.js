                    ...
                    <Col>
                        ...
                        <ul>
                            <li className="list-group-item">
                                <a href="#">Casa Panciu wine cellar</a>
                            </li>
                            <li className="list-group-item">
                                <a href="#">Map</a>
                            </li>
